...
benchTests
  = group "Benchmarks" [
     ...
     , testGroup "popl17_pos"   <$> dirTests "benchmarks/popl17/pos"             ["OverviewListInfix.hs"]                        ExitSuccess
    , testGroup "popl17_neg"   <$> dirTests "benchmarks/popl17/neg"             ["Proves.hs", "Helper.hs"]             (ExitFailure 1)
    ]
