...
errorTests = group "Error-Messages"
  ...
  , errorTest "tests/errors/CyclicExprAlias1.hs"    2 "Cyclic type alias definition for `CyclicB2`" 
  ...
  -- TODO ?, errorTest "tests/errors/MissingField.hs"        2 "Error: Unknown field `goober`" 
  ]
