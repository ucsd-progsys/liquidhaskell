...
benchTests
  = group "Benchmarks" [
    ...
    -- NOPROP , testGroup "pldi17_pos"   <$> dirTests "benchmarks/pldi17/pos"               proverIgnored             ExitSuccess
    -- NOPROP , testGroup "pldi17_neg"   <$> dirTests "benchmarks/pldi17/neg"               proverIgnored             (ExitFailure 1)
     ]
