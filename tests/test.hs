...
errorTests = group "Error-Messages"
  ...
  , errorTest "tests/errors/UnboundVarInAssume1.hs" 2 "Illegal type specification for `UnboundVarInAssume1.b`"
  ...
  , errorTest "tests/errors/HigherOrderBinder.hs"   2 "Illegal type specification for `HigherOrderBinder.foo`"
