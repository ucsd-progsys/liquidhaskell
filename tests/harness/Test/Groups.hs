...
errorTest2 :: FilePath -> String -> Map FilePath ErrorMsg
errorTest2 fp e = M.singleton fp (T.pack e)

-- | A large map of all the `ErrorMsg` fragments for the `errors` TestGroup.
errorMsgs2 :: Map FilePath ErrorMsg
errorMsgs2 = M.unions
  [ 
    -- errorTest "tests/errors/ExportMeasure0.hs"      2 "Cannot lift `llen` into refinement logic"
    -- errorTest "tests/errors/ExportReflect0.hs"      2 "Cannot lift `identity` into refinement logic"
    ...
    errorTest2 "tests/errors/ReWrite8.hs"            "Could not generate any rewrites from equality"
  , errorTest2 "tests/errors/ReWrite7.hs"            "Could not generate any rewrites from equality"
  , errorTest2 "tests/errors/ReWrite6.hs"            "Unable to use ReWrite6.bad as a rewrite because it does not prove an equality"
  , errorTest2 "tests/errors/ReWrite5.hs"            "parameter \"xs\" contains an inner refinement"
  , errorTest2 "tests/errors/ShadowFieldInline.hs"   "Multiple specifications for `pig`"
  , errorTest2 "tests/errors/ShadowFieldReflect.hs"  "Multiple specifications for `pig`"
  , errorTest2 "tests/errors/MultiRecSels.hs"        "Duplicated definitions for field `left`" 
  , errorTest2 "tests/errors/DupFunSigs.hs"          "Multiple specifications for `DupFunSigs.fromWeekDayNum`"
  , errorTest2 "tests/errors/DupMeasure.hs"          "Multiple specifications for `lenA`"
  , errorTest2 "tests/errors/ShadowMeasure.hs"       "Multiple specifications for `shadow`"
  , errorTest2 "tests/errors/DupData.hs"             "Multiple specifications for `OVec`"
  , errorTest2 "tests/errors/EmptyData.hs"           "one or more fields in the data declaration for `A`"
  , errorTest2 "tests/errors/BadGADT.hs"             "Specified type does not refine Haskell type for `BadGADT.Nil2`" 
  , errorTest2 "tests/errors/TerminationExprSort.hs" "Illegal termination specification for `TerminationExprSort.showSep`"
  , errorTest2 "tests/errors/TerminationExprNum.hs"  "Illegal termination specification for `TerminationExprNum.showSep`"
  , errorTest2 "tests/errors/TerminationExprUnb.hs"  "Illegal termination specification for `go`"
  , errorTest2 "tests/errors/UnboundVarInSpec.hs"    "Illegal type specification for `UnboundVarInSpec.foo`"
  , errorTest2 "tests/errors/UnboundVarInAssume.hs"  "Illegal type specification for `UnboundVarInAssume.incr`"
  -- XXX(matt.walker) disabled because Fixpoint.Types.dummyLoc is impossible to associate with a location
  -- , errorTest2 "tests/errors/UnboundCheckVar.hs"     "Unknown variable `UnboundCheckVar.ink`"
  , errorTest2 "tests/errors/UnboundFunInSpec.hs"    "Illegal type specification for `UnboundFunInSpec.three`"
  , errorTest2 "tests/errors/UnboundFunInSpec1.hs"   "Illegal type specification for `UnboundFunInSpec1.foo`"
  , errorTest2 "tests/errors/UnboundFunInSpec2.hs"   "Illegal type specification for `UnboundFunInSpec2.foo`"
  , errorTest2 "tests/errors/UnboundVarInLocSig.hs"  "Illegal type specification for `bar`" 
  , errorTest2 "tests/errors/UnboundVarInReflect.hs" "Illegal type specification for `UnboundVarInReflect.frog`" 
  , errorTest2 "tests/errors/Fractional.hs"          "Illegal type specification for `Fractional.f`"
  , errorTest2 "tests/errors/T773.hs"                "Illegal type specification for `T773.incr`"
  , errorTest2 "tests/errors/T774.hs"                "Illegal type specification for `T774.incr`"
  , errorTest2 "tests/errors/T1498.hs"               "Standalone class method refinement"
  , errorTest2 "tests/errors/T1498A.hs"              "Bad Data Specification"
  , errorTest2 "tests/errors/Inconsistent0.hs"       "Specified type does not refine Haskell type for `Inconsistent0.id1`" 
  , errorTest2 "tests/errors/Inconsistent1.hs"       "Specified type does not refine Haskell type for `Inconsistent1.incr` (Checked)"
  , errorTest2 "tests/errors/Inconsistent2.hs"       "Specified type does not refine Haskell type for `Inconsistent2.foo` (Checked)"
  , errorTest2 "tests/errors/BadAliasApp.hs"         "Malformed application of type alias `ListN`"
  , errorTest2 "tests/errors/BadPragma0.hs"          "Illegal pragma"
  , errorTest2 "tests/errors/BadPragma1.hs"          "Illegal pragma"
  , errorTest2 "tests/errors/BadPragma2.hs"          "Illegal pragma"
  , errorTest2 "tests/errors/BadSyn1.hs"             "Malformed application of type alias `Fooz`"
  , errorTest2 "tests/errors/BadSyn2.hs"             "Malformed application of type alias `BadSyn2.Foo`"
  , errorTest2 "tests/errors/BadSyn3.hs"             "Malformed application of type alias `BadSyn3.Foo`"
  , errorTest2 "tests/errors/BadSyn4.hs"             "Malformed application of type alias `BadSyn4.Point`"
  , errorTest2 "tests/errors/BadAnnotation.hs"       "Malformed annotation"
  , errorTest2 "tests/errors/BadAnnotation1.hs"      "Malformed annotation"
  , errorTest2 "tests/errors/CyclicExprAlias0.hs"    "Cyclic type alias definition"
  , errorTest2 "tests/errors/CyclicExprAlias1.hs"    "Cyclic type alias definition" 
  , errorTest2 "tests/errors/CyclicExprAlias2.hs"    "Cyclic type alias definition"
  , errorTest2 "tests/errors/CyclicExprAlias3.hs"    "Cyclic type alias definition"
  , errorTest2 "tests/errors/DupAlias.hs"            "Multiple definitions of Type Alias `BoundedNat`"
  , errorTest2 "tests/errors/DupAlias.hs"            "Multiple definitions of Pred Alias `Foo`"
  , errorTest2 "tests/errors/BadData0.hs"            "Unknown type constructor `Zoog`" 
  , errorTest2 "tests/errors/BadDataConType.hs"      "Illegal type specification for `BadDataConType.fldY`" 
  , errorTest2 "tests/errors/BadDataConType1.hs"     "Specified type does not refine Haskell type for `BadDataConType1.C`" 
                                                       -- "Illegal type specification for `Boo.fldY`" 

  , errorTest2 "tests/errors/BadDataConType2.hs"     "different numbers of fields for `BadDataConType2.C`" 
  , errorTest2 "tests/errors/LiftMeasureCase.hs"     "Cannot create measure 'LiftMeasureCase.foo': Does not have a case-of at the top-level"
  , errorTest2 "tests/errors/HigherOrderBinder.hs"   "Illegal type specification for `HigherOrderBinder.foo`"
  , errorTest2 "tests/errors/HoleCrash1.hs"          "Illegal type specification for `HoleCrash1.t`"
  , errorTest2 "tests/errors/HoleCrash2.hs"          "Malformed application of type alias `Geq`"
  , errorTest2 "tests/errors/HoleCrash3.hs"          "Specified type does not refine Haskell type for `HoleCrash3.countUp`"
  , errorTest2 "tests/errors/BadPredApp.hs"          "Malformed predicate application"
  , errorTest2 "tests/errors/LocalHole.hs"           "Illegal type specification for `go`"
  , errorTest2 "tests/errors/UnboundAbsRef.hs"       "Cannot apply unbound abstract refinement `p`"
  -- , errorTest2 "tests/errors/BadQualifier.hs"        2 "Illegal qualifier specification for `Foo`"
  , errorTest2 "tests/errors/ParseClass.hs"          "Cannot parse specification"
  , errorTest2 "tests/errors/ParseBind.hs"           "Cannot parse specification"
  , errorTest2 "tests/errors/MultiInstMeasures.hs"   "Multiple instance measures `sizeOf` for type `GHC.Ptr.Ptr`"
  , errorTest2 "tests/errors/BadDataDeclTyVars.hs"   "Mismatch in number of type variables for `L`"
  , errorTest2 "tests/errors/BadDataCon2.hs"         "GHC and Liquid specifications have different numbers of fields for `BadDataCon2.Cuthb`"
  , errorTest2 "tests/errors/BadSig0.hs"             "Illegal type specification for `BadSig0.foo`"
  , errorTest2 "tests/errors/BadSig1.hs"             "Illegal type specification for `BadSig1.EZ`"
  , errorTest2 "tests/errors/BadData1.hs"            "Data constructors in refinement do not match original datatype for `EntityField`"
  , errorTest2 "tests/errors/BadData2.hs"            "Data constructors in refinement do not match original datatype for `Hog`"
  , errorTest2 "tests/errors/T1140.hs"               "Specified type does not refine Haskell type for `T1140.foo`"
  , errorTest2 "tests/errors/InlineSubExp0.hs"       "== f B C"
  , errorTest2 "tests/errors/InlineSubExp1.hs"       "= f B (g A)"
  , errorTest2 "tests/errors/EmptySig.hs"            "Cannot parse specification"
  , errorTest2 "tests/errors/MissingReflect.hs"      "Illegal type specification for `MissingReflect.empty_foo`" 
  , errorTest2 "tests/errors/MissingSizeFun.hs"      "Unknown variable `llen2`" 
  , errorTest2 "tests/errors/MissingAssume.hs"       "Unknown variable `goober`" 
  , errorTest2 "tests/errors/HintMismatch.hs"        "HINT: Use the hole"
  -- XXX(matt.walker): disabled because it prints the error to stdout (!!)
  -- , errorTest2 "tests/errors/ElabLocation.hs"        "ElabLocation.hs:13:14-13:15: Error"
  , errorTest2 "tests/errors/ErrLocation.hs"         "ErrLocation.hs:9:13"
  , errorTest2 "tests/errors/ErrLocation2.hs"        "ErrLocation2.hs:11:20:error"
  , errorTest2 "tests/errors/Frog.hs"                "Unbound symbol GHC.Err.undefined"
  , errorTest2 "tests/errors/T1708.hs"               "Unbound symbol T1708.bool1"
  , errorTest2 "tests/errors/SplitSubtype.hs"        "| VV > 5}"
  -- , errorTest2 "tests/errors/UnknownTyConHole.hs"    2 "HINT: Use the hole" 
  -- TODO-REBARE ?, errorTest2 "tests/errors/MissingField1.hs"        2 "Error: Unknown field `goober`" 
  -- TODO-REBARE ?, errorTest2 "tests/errors/MissingField2.hs"        2 "Error: Unknown field `fxx`" 
  , errorTest2 "tests/errors/PositivityCheck.hs"     "Negative occurence of PositivityCheck.Bad1"
  , errorTest2 "tests/errors/Positivity1.hs"         "Negative occurence of Positivity1.Rec"
  , errorTest2 "tests/errors/Positivity2.hs"         "Negative occurence of Positivity2.Evil in Positivity2.Very"
  ]
