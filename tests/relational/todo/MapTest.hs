...
diff (Cons x xs) (Cons y ys) | x == y = diff xs ys
diff (Cons x xs) (Cons y ys) | x /= y = 1 + diff xs ys
diff _ _                              = 0
...
diff' (Cons x xs) (Cons y ys) | x == y = True && diff' xs ys
diff' (Cons x xs) (Cons y ys) | x /= y = False && diff' xs ys
diff' _ _                              = True
