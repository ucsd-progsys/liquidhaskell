...
refTopQuals :: (PPrint t, IsReftV t,  ReftBind t ~ Symbol, ReftVar t ~ Symbol, Variable t ~ Symbol, SubsTy RTyVar RSort t)
            => SEnv Sort
            -> ElabFlags
            -> SourcePos
            -> TCEmb TyCon
...
mkPQual :: (PPrint r, IsReftV r,  ReftBind r ~ Symbol, ReftVar r ~ Symbol, Variable r ~ Symbol, SubsTy RTyVar RSort r)
        => SEnv Sort
        -> SourcePos
        -> TCEmb TyCon
        -> t
