...
-- | @myRTEnv@ slices out the part of RTEnv that was generated by expression
--   aliases defined in the _target_ file, removes type aliases with duplicate
--   unqualified names, and "cooks" the type aliases by conversion to SpecType
--   and back to BareType.
--------------------------------------------------------------------------------
