...
I have been busy preparing an undergraduate course on
...
(The conversion is _also_ a key step for refinement
type systems like LiquidHaskell, as it simplifies
the rule for dependent function application.)
