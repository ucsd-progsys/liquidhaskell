...
isSubsetOf    :: (Ord a) => x:(Data.Set.Set a) -> y:(Data.Set.Set a) -> {v:Bool | ((Prop v) <=> (Data.Set.Set_sub x y))}
member        :: (Ord a) => x:a -> xs:(Data.Set.Set a) -> {v:Bool | ((Prop v) <=> (Data.Set.Set_mem x xs))}

empty         :: {v:(Data.Set.Set a) | (Data.Set.Set_emp v)}
