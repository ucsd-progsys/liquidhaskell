-- | This module contains the code for converting @BareType@ into @SpecType@.
...
ofMeaSort = ofBRType failRTAliasApp return
...
txParam :: SourcePos-> ((UsedPVar -> UsedPVar) -> t) -> [UsedPVar] -> RType c tv r -> t
