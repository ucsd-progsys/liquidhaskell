...
instance (Reftable r, TyConable c {- , RefTypable c tv r -} ) => Subable (RTProp c tv r) where
...
instance (Subable r, Reftable r, TyConable c {- , RefTypable c tv r -}) => Subable (RType c tv r) where
